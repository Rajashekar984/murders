...
abc<-read_csv(url,col_names = FALSE)
View(abc)
...
a<-setdiff(awards_2016$playerID,top_names$playerID)
ncol(a)
length(a)
...
tab2 <- tab2[-1, ]
full_data <- full_join(tab1, tab2, by = "Team")
View(full_data)
...
View(tab)
table1 <- html_table(tab[[6]], fill = TRUE)
table1
...
# Rename columns
colnames(polls) <- c("dates", "remain", "leave", "undecided", 
